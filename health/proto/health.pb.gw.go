...
// source: api/sampleproject/health.proto
...
func request_Health_Check_0(ctx context.Context, marshaler runtime.Marshaler, client grpc_health_v1.HealthClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Health_Check_0(ctx context.Context, marshaler runtime.Marshaler, server grpc_health_v1.HealthServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq grpc_health_v1.HealthCheckRequest
	var metadata runtime.ServerMetadata
...
func RegisterHealthHandlerServer(ctx context.Context, mux *runtime.ServeMux, server grpc_health_v1.HealthServer) error {
	...
	mux.Handle("GET", pattern_Health_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/grpc.health.v1.Health/Check", runtime.WithHTTPPathPattern("/health/v1/check"))
		if err != nil {
...
func RegisterHealthHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterHealthHandlerClient(ctx, mux, grpc_health_v1.NewHealthClient(conn))
}
...
func RegisterHealthHandlerClient(ctx context.Context, mux *runtime.ServeMux, client grpc_health_v1.HealthClient) error {
	...
	mux.Handle("GET", pattern_Health_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/grpc.health.v1.Health/Check", runtime.WithHTTPPathPattern("/health/v1/check"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Health_Check_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"health", "v1", "check"}, ""))
)
